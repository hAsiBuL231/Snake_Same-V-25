...
class _SignUpPageState extends State<SignUpPage> {
  ...
  Widget build(BuildContext context) {
    return Container(
        decoration:
            const BoxDecoration(image: DecorationImage(image: AssetImage("Assets/login.png"), fit: BoxFit.cover)),
        child: Scaffold(
            ...
            body: SingleChildScrollView(
                ...
                child: Column(children: [
                  const Image(image: AssetImage('Assets/Images/image2.png'), height: 230, fit: BoxFit.cover),
                  const Text("Create New\nAccount",
                      textAlign: TextAlign.center,
                      style: TextStyle(fontSize: 40, color: Colors.black, fontFamily: "Raleway")),
                  TextButton(
                      onPressed: () {

...
import 'package:snake_game_v_25/Settings%20Folder/InfoPage.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
            ...
            bottom: PreferredSize(child: Text("by MD. Hasibul Hossain", style: TextStyle(fontSize: 14, color: Colors.white70)), preferredSize: Size.zero),
            actions: <Widget>[
              /*IconButton(
          ...
          child: Column(children: <Widget>[
            ...
            Column(children: [
              ...
              Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                ...
                const SizedBox(width: 30),
                GestureDetector(onTap: () => nextPage(InfoPage(), context), child: const Image(image: AssetImage('Assets/Buttons/about.png'), height: 80, width: 80)),
              ]),
            ]),
          ]),
        ));
